...
import { Calendar, MapPin, Clock, Sparkles, Heart, Flame, Music, Star } from 'lucide-react';
  ...
  const events: EventItem[] = [
    {
      ...
      description: 'The auspicious pre-wedding ceremony marking the formal acceptance of the alliance with traditional tilak and exchange of gifts.',
      icon: Sparkles,
      colorStr: 'red',
    ...
    },
    {
      ...
      venueName: 'Shringi House',
      venueAddress: 'Lane No. 2, Baran Road, Kota, Rajasthan',
      description: 'Prayers offered with pure devotion to seek blessing from the Divine Mother for prosperity, peace, and togetherness.',
      icon: Heart,
      colorStr: 'rose',
    ...
    },
    {
      ...
      description: 'Ceremonial installation of the holy vessel representing health and wellness to welcome the celebratory wedding spirits.',
      icon: Sparkles,
      colorStr: 'amber',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'A playful ritual where fresh turmeric paste is lovingly applied on Mayank and Ritika to make them glow for their sacred vows.',
      icon: Sparkles,
      colorStr: 'yellow',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'An evening of celebration, live traditional melodies, beautiful family dances, and immense joy.',
      icon: Music,
      colorStr: 'purple',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'The beautiful exchange of rings, completing the formal promise to stand by each other forever.',
      icon: Heart,
      colorStr: 'indigo',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'The joyous royal wedding procession of the groom accompanied by lively music, dhol beats, and dancing.',
      icon: Sparkles,
      colorStr: 'orange',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'The sacred fire ritual which unites Mayank & Ritika for seven lifetimes with holy vows of fidelity and absolute companionship.',
      icon: Flame,
      colorStr: 'red',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'The emotional moment of the bride bade farewell as she starts her primary journey into her new home with Mayank.',
      icon: Sparkles,
      colorStr: 'amber',
      borderTheme: 'border-amber-600/30 hover:border-amber-600',
      bgTheme: 'bg-gradient-to-br from-amber-50/80 to-white',
    ...
    },
    {
      ...
      venueName: 'Parihar Marriage Garden',
      venueAddress: 'Bandha Dharm Pura Road, Hadoti Colony, Kota',
      description: 'A formal celebratory feast to present the newlyweds and celebrate with friends, family, and well-wishers.',
      icon: Star,
      colorStr: 'emerald',
  ...
  return (
    <section className="w-full py-24 px-4 bg-gradient-to-b from-cream-base via-cream-dark/20 to-cream-base relative select-none">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.04] overflow-hidden flex items-center justify-center">
        <svg className="w-[900px] h-[900px] text-amber-900" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center mb-20">
          <div className="flex justify-center items-center gap-2 mb-3">
            <svg className="w-8 h-8 text-amber-600 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.907c.961 0 1.36 1.25.591 1.813l-3.97 2.87a1 1 0 00-.364 1.118l1.52 4.674c.3.921-.755 1.688-1.538 1.118l-3.971-2.87a1 1 0 00-1.176 0l-3.97 2.87c-.783.57-1.838-.197-1.538-1.118l1.52-4.674a1 1 0 00-.364-1.118l-3.97-2.87c-.768-.563-.369-1.813.591-1.813h4.907a1 1 0 00.95-.69l1.519-4.674z" />
            </svg>
            <span className="text-xs uppercase tracking-[0.35em] font-extrabold text-amber-800">Shubh Vivah Program</span>
            <svg className="w-8 h-8 text-amber-600 animate-pulse transform scale-x-[-1]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.907c.961 0 1.36 1.25.591 1.813l-3.97 2.87a1 1 0 00-.364 1.118l1.52 4.674c.3.921-.755 1.688-1.538 1.118l-3.971-2.87a1 1 0 00-1.176 0l-3.97 2.87c-.783.57-1.838-.197-1.538-1.118l1.52-4.674a1 1 0 00-.364-1.118l-3.97-2.87c-.768-.563-.369-1.813.591-1.813h4.907a1 1 0 00.95-.69l1.519-4.674z" />
            </svg>
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl text-red-850 font-bold tracking-tight">Wedding Itinerary</h2>
          ...
          <p className="text-xs sm:text-sm text-stone-605 mt-4 max-w-lg mx-auto leading-relaxed uppercase tracking-wider font-semibold">
            Please join us in celebrating every beautiful phase of our forever journey.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 md:-ml-px bg-gradient-to-b from-amber-500/25 via-amber-500/60 to-amber-500/25 pointer-events-none">
            ...
            <div className="sticky top-1/3 flex flex-col items-center gap-16 pointer-events-none opacity-30">
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="w-2.5 h-2.5 rounded-full bg-orange-500 border border-amber-300" />
              ))}
            </div>
          </div>
          ...
          <div className="space-y-12 md:space-y-16">
            {events.map((ev, idx) => {
              ...
              return (
                <div key={ev.id} className="relative flex flex-col md:flex-row items-stretch">
                  ...
                  <div className={`w-full md:w-1/2 pl-12 pr-4 md:pr-12 md:pl-0 text-left md:text-right flex flex-col justify-center ${isEven ? 'md:items-end' : 'md:hidden'}`}>
                    {isEven && (
                      <motion.div
                  ...
                  {/* Card Block Column */}
                  <div className={`w-full md:w-1/2 pl-12 md:pl-12 text-left ${isEven ? '' : 'md:order-last'}`}>
                    
                    {/* Mobile date marker indicator */}
                    <div className="md:hidden flex items-baseline gap-2 mb-2">
                      <span className="font-serif text-2xl font-black text-red-800">{ev.dayNum}</span>
                      <span className="text-[10px] font-bold uppercase tracking-widest text-amber-800">{ev.monthYear} ({ev.date.split(',')[0]})</span>
                    </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className={`text-[9px] font-extrabold uppercase tracking-widest px-2.5 py-0.5 rounded-full ${ev.badgeTheme}`}>
                              {ev.title === 'Phere (Holy Matrimony)' ? 'MANGAL PHERE' : 'AUSPICIOUS RITUAL'}
                            </span>
                          </div>
                          
                          <h3 className={`font-serif text-xl sm:text-2xl font-bold tracking-tight ${ev.textTheme}`}>
                            {ev.title}
                          </h3>
                        ...
                        <div className="bg-amber-50/40 p-4 rounded-xl border border-amber-500/15 flex items-start gap-3">
                          ...
                          <div className="text-xs space-y-0.5 text-stone-850">
                            <span className="font-extrabold tracking-wide block">{ev.venueName}</span>
                            <span className="text-[11px] text-stone-500 mt-1 block leading-relaxed">{ev.venueAddress}</span>
                          </div>
                        </div>
                  ...
                  <div className={`w-full md:w-1/2 pr-12 pl-4 md:pl-12 md:pr-0 text-left flex flex-col justify-center ${!isEven ? 'md:items-start' : 'md:hidden'}`}>
                    {!isEven && (
                      <motion.div
                        initial={{ opacity: 0, x: 30 }}
                        whileInView={{ opacity: 1, x: 0 }}
        ...
        <div className="mt-20 text-center max-w-2xl mx-auto p-8 rounded-2xl bg-amber-50/20 border border-amber-200/20 select-none">
          <div className="inline-flex justify-center items-center gap-2 text-amber-800 opacity-80 mb-3">
            ...
            <span className="font-serif italic font-extrabold text-sm text-red-900 tracking-wide block">
              "Mangalyam Tantunanena Bhartur Jivana Hetuna, Kanthe Badhnami Subhage Tvam Jiva Sharadah Shatam"
            </span>
          </div>
          <p className="text-[10px] sm:text-xs text-stone-550 leading-relaxed max-w-md mx-auto">
            "This is a sacred thread designed for secure companion and of absolute trust. I bind this, O beautiful lady, around your neck, may you live happily for a hundred autumns."
          </p>
        </div>
